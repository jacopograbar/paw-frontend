...
var _default = exports.default = new SignupSeekerView();
...
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/shelterPage.js":[function(require,module,exports) {
"use strict";
...
class ShelterPageView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Shelter Page\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Shelter Page</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new ShelterPageView();
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/pet.js":[function(require,module,exports) {
"use strict";
...
class PetView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Pet\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Pet</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new PetView();
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/myApplications.js":[function(require,module,exports) {
"use strict";
...
class MyApplicationsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"My Applications\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>My Applications</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new MyApplicationsView();
...
var _shelterPage = _interopRequireDefault(require("./views/pages/shelterPage"));
var _pet = _interopRequireDefault(require("./views/pages/pet"));
var _myApplications = _interopRequireDefault(require("./views/pages/myApplications"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import views
...
const routes = {
  '/': _home.default,
  '404': _.default,
  '/login': _signin.default,
  '/signup': _signupFirst.default,
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
customElements.define("paw-header", class AppHeader extends _litElement.LitElement {
  constructor() {
    super();
  }
